...
keytool -importkeystore -srckeystore $KEYSTORE_DIR/$KEYSTORE -srcstoretype JKS -srcstorepass $STOREPASS -destkeystore $PKCS_KEYSTORE_DIR/$PKCS_KEYSTORE -deststoretype PKCS12 -srcalias $CERT_ALIAS -destkeypass $STOREPASS -deststorepass $STOREPASS
